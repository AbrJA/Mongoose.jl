...
# WsEndpoint is defined in ws/types.jl
...
# Static router WS upgrade stub — overridden by @static_router macro
function static_ws_upgrade(::StaticRouter, ::String) nothing end
