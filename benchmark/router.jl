...
SUITE["dispatch"]["fixed"] = @benchmarkable Mongoose._dispatch_to_router($ROUTER, $REQ_ROOT)
SUITE["dispatch"]["dynamic"] = @benchmarkable Mongoose._dispatch_to_router($ROUTER, $REQ_USERS)
SUITE["dispatch"]["miss"] = @benchmarkable Mongoose._dispatch_to_router($ROUTER, $REQ_MISS)
